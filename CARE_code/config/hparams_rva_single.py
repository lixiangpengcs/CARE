...
RVABASE_PARAMS = defaultdict(
  ...
  encoder='rvamodel', # [basemodel, mvan, transformermodel, rvamodel]
...
RVA_MULTI_PARAMS= RVABASE_PARAMS.copy()
RVA_MULTI_PARAMS.update(
  gpu_ids=[0],
  num_epochs=15,
  train_batch_size=32, # 32 x num_gpus is a good rule of thumb
  eval_batch_size=32,
